...
/*   Updated: 2022/02/03 19:34:21 by thakala          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_current_board_depth_cursor(t_bitarr *bitarr, t_tetri *tetriminoes, \
	uint8_t board_size, uint8_t recursion_depth, uint16_t current_index)
{
	char		*board_state;
	uint64_t	tetrilong;
	uint16_t	index;
